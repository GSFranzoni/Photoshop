...
public class FileScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jFileChooser.setCurrentDirectory(new File(System.getProperty("user.dir") + "/Imagens"));
    ...
    private void jFileChooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooserActionPerformed
        try {
            image = ImageIO.read(new File(this.jFileChooser.getSelectedFile().getAbsolutePath().replaceAll("\\\\", "\\\\\\\\")));
        } 
        catch (Exception ex) {
